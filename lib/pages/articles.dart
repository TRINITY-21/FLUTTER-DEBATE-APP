...
import 'package:debate/pages/addComment.dart';
import 'package:debate/pages/uploadArticle.dart';
...
class _ArticlesState extends State<Articles>
  ...
  fetchArticles() async {
    final debates =
        await networkHandler.get('/api/article/fetch-approved-article');
    print('Articles $debates');
    setState(() {
